...
public class Gripper {
    ...
    //Variable for laser distance
    public boolean containerPositioned;
    ...
    public void update() {
        ...
        containerPositioned = Input.Digital.CONTAINER_POSITION_LASER.get();
        ...
        if (gripperExtended) {
            ...
            if (!isSuckedIn) {
                ...
                if (motorsStressed() || containerPositioned) {
                    isSuckedIn = true;
                    startTime = System.currentTimeMillis();
                }
